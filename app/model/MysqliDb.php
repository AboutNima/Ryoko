...
class MysqliDb
{
	...
	/* Helper functions */
	public function nowShams()
	{
		$fmt=new IntlDateFormatter("fa_IR@calendar=persian",IntlDateFormatter::SHORT,IntlDateFormatter::MEDIUM,'Asia/Tehran',IntlDateFormatter::TRADITIONAL);
...
$db=new MysqliDb($ini['Database']['host'],$ini['Database']['user'],$ini['Database']['pass'],$ini['Database']['database'],$ini['Database']['port'],$ini['Database']['charset'],$ini['Database']['socket']);
$db->autoReconnect=$ini['Database']['autoReconnect'];
// END class